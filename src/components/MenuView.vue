<template>
  ...
  <div class="menu">
    <h3>메뉴</h3>
    <a href="#" class="mn-cart">장바구니</a>
    <a href="#" class="mn-close">닫기</a>
    <div>
      <h4>쇼핑하기</h4>
  ...
  export default {
    setup(){
      onMounted(() => {
        ...
        // 메뉴닫기
        let mnClose = $('.mn-close');
        mnClose.click(function(event){
          event.preventDefault();
...
<style scoped>
  ...
  .mn-category li:hover {
    background: #f6f6f6;
  }

  .mn-category li:nth-child(4n) {
    margin-right: 0;
  }
